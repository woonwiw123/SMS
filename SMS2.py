...
print("")
print("")
print("    เครดิตFB :\033[1;96mhttps://www.facebook.com/SaremSak")
print("")
print("ไม่เข้าใจให้ถาม")
for i in range(3):
    pwd = input ("โปรดใส่รหัสผ่าน : ")
    l=3
    if(pwd==password):
     print("ACCES GRANTED")
     break
    else:
        print("\033[1;96mรหัสไม่ถูกโปรดลองใหม่อีกครั้ง\033[1;97m",i-l)
os.system("clear")
os.system("figlet S   P   A   M   S   M   S")
print ("\tยิงเบอร์ 2.0")
print("    เครดิตFB :\033[1;96mhttps://www.facebook.com/SaremSak                                    			")
print("               กรุณาใช้ในทางที่ดี !!!")
print ("           YouTube: \033[1;96mOPSGaming\033[1;97m")
print ("          \033[1;96m S  P  A  M  S  M  S\033[1;97m")
print("***********--***********")
session = requests.Session()
print ("\033[90m>\033[1;97m ตัวอย่าง: \033[1;92m66012345678")
